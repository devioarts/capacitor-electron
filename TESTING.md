...
| App Menu<br><sub>Native application menu bar configured via `menu` in capacitor.config; editMenu, viewMenu options</sub> | [app-menu.md](docs/app-menu.md) | ❌ | ✅ | 🧪 | Mac not working |
